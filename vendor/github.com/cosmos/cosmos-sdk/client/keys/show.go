...
func runShowCmd(cmd *cobra.Command, args []string) (err error) {
	...
	fmt.Println(isShowAddr,isShowPubKey,isShowDevice)
	...
	fmt.Println("bechPrefix:",bechPrefix)
	fmt.Println("bechKeyOut:",bechKeyOut)
	if err != nil {
		return err
	}
	...
	default:
		fmt.Println("clientCtx.OutputFormat:",clientCtx.OutputFormat)
		fmt.Println("info:",info)
		fmt.Println(cmd.OutOrStdout())
		fmt.Println(bechKeyOut)
