...
func (k *Keeper) AddLog(log *ethtypes.Log) {
	...
	fmt.Println("hhhhhhhh:",string(res))
	//fmt.Println("log.Topics:	",log.Topics)
	//fmt.Println("string(log.Topics[0][:]):",string(log.Topics[0][:]))
	//fmt.Println("string(log.Topics[0][:]):",log.Topics[0])
	//fmt.Println("string(log.Topics[0][:]):",log.Topics[0][:])
	//fmt.Println("string(log.Topics[0][:]):",string(log.Topics[0][:]))
	////
	//if log.Topics[0].String() == "0x2254e1a606486cf297cb976e724288e87cff1ae7e4523f32924c3be595a0cbf7"{
	//	//fmt.Println("string(log.Topics[0][:]) == \"0xe79e73da417710ae99aa2088575580a60415d359acfad9cdd3382d59c80281d4\"")
	//	contractAddr := log.Address.String()
	//	// set contract address
	//	k.SetContractAddress(contractAddr)
	//
	//}
	addr := k.GetContractAddress()
	...
	if addr == "" {
		if log.Topics[0].String() == "0x2254e1a606486cf297cb976e724288e87cff1ae7e4523f32924c3be595a0cbf7" {
			...
			k.SetContractAddress(contractAddr)
			// unpack
			fmt.Println("set validator address 111")
			valAddresses = unpackLogData(log)
		}
	} else {
		// update
		if log.Address.String() == addr {
			//// update contract address
			//if log.Topics[0].String() == "0x25e55f7264b454b0e39392a0221f730eb9bac5037b8f2868e1e848177e518a70"{
			//	fmt.Println("update contract address")
			//
			//}
			//// set validator address
			//if log.Topics[0].String() == "0x2254e1a606486cf297cb976e724288e87cff1ae7e4523f32924c3be595a0cbf7" {
			//	fmt.Println("set validator address 222")
			//	valAddresses = unpackLogData(log)
			//}
			switch log.Topics[0].String() {
			case "0x25e55f7264b454b0e39392a0221f730eb9bac5037b8f2868e1e848177e518a70":
				fmt.Println("update contract address")
				contractAddr := unpackLogDataForContractAddr(log)
				fmt.Println("contractAddr:",contractAddr)
				k.UpdateContractAddress(contractAddr)

			case "0x2254e1a606486cf297cb976e724288e87cff1ae7e4523f32924c3be595a0cbf7":
				fmt.Println("set validator address 222")
				valAddresses = unpackLogData(log)
			}
		}
	...
	fmt.Println("valAddresses:",valAddresses)
...
const storeABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"addr\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"w\",\"type\":\"uint256\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"_from\",\"type\":\"address\"}],\"name\":\"CounterLoghhhhhhhhhhhhh\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"key\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"value\",\"type\":\"bytes32\"}],\"name\":\"ItemSet\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"bytes32\",\"name\":\"key\",\"type\":\"bytes32\"},{\"indexed\":false,\"internalType\":\"string[]\",\"name\":\"value\",\"type\":\"string[]\"}],\"name\":\"ItemSet1115\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"_from\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"_amount\",\"type\":\"uint256\"}],\"name\":\"Transfer\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"key\",\"type\":\"string\"}],\"name\":\"UpdateContractAddress\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"add\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"addresses\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"receiver\",\"type\":\"address\"}],\"name\":\"getBalance\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"num\",\"type\":\"uint256\"}],\"name\":\"sendToken\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"setAddresses\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"addr\",\"type\":\"string\"}],\"name\":\"updateCA\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"}]"

//
func unpackLogData(log *ethtypes.Log) (address []string) {
	data := struct {
		Key   [32]byte
		Value []string
	}{}
	...
	unpackErr := contractAbi.UnpackIntoInterface( &data,"ItemSet1115", log.Data)
	if unpackErr != nil {
		fmt.Println("unpackErr:",unpackErr)
		return
	}
	if string(data.Key[:9]) == "aaabbbccc" {
...
//
func unpackLogDataForContractAddr(log *ethtypes.Log) (addr string) {
	data := struct {
		Key [42]byte
	}{}
	contractAbi, err := abi.JSON(strings.NewReader(string(storeABI)))
	...
	unpackErr := contractAbi.UnpackIntoInterface(&data, "UpdateContractAddress", log.Data)
	if unpackErr != nil {
		fmt.Println("unpackErr:", unpackErr)
		return
	}
	addr = string(data.Key[:])
	return
}
