...
var (
	...
	KeyPrefixContractAddress    = []byte{prefixContractAddress}
	KeyPrefixValidatorAddresses = []byte{prefixValidatorAddresses}
)
...
//
var (
	KeyOfContractAddress    = "KeyOfContractAddress123456"
	KeyOfValidatorAddresses = "KeyOfValidatorAddresses"
)
