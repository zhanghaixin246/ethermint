...
ethermintd add-genesis-account $KEY 123400000000000000000000000000aphoton --keyring-backend $KEYRING

# Sign genesis transaction
ethermintd gentx $KEY 12345000000aphoton --keyring-backend $KEYRING --chain-id $CHAINID
